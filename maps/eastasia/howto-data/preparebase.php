...
$message = '';
		...
		if (is_writable('newbase.svg')) { echo "is writeable<br/>"; }
		...
		$numbytes = file_put_contents('newbase.svg', $newsvgtext);
  		echo "Wrote ($numbytes) bytes to file (newbase.svg)";
